...
async function performOCR() {
  ...
  console.log("textResults =", textResults, textResults[1].length)
...
function updatedMouseBrain (textResults, rectangle) {
  switch (rectangles[1].subject) {
    case 'right corner':
      // check for 
      break;
